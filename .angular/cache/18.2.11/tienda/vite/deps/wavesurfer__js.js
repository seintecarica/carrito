...
var h = class _h extends e {
  ...
  initEvents() {
    ...
    if (this.wrapper.addEventListener("click", (e2) => {
      ...
      const {
        ...
        scrollWidth: e2,
        clientWidth: i2
      } = this.scrollContainer, s2 = t3 / e2, n2 = (t3 + i2) / e2;
    ...
    this.subscriptions.push(function(t2, e2, i2, s2, n2 = 3, r2 = 0, o2 = 100) {
      ...
      const l2 = (l3) => {
        ...
        const p = Date.now(), m = (s3) => {
          ...
          if (u2) {
            const i3 = e3.clientX, n3 = e3.clientY, r3 = t2.getBoundingClientRect(), {
              left: o3,
              top: a3
            } = r3;
  ...
  initHtml() {
    const t2 = document.createElement("div"), e2 = t2.attachShadow({
      mode: "open"
  ...
  renderBarWaveform(t2, e2, i2, s2) {
    const n2 = t2[0], r2 = t2[1] || t2[0], o2 = n2.length, {
      width: a2,
      height: h2
    } = i2.canvas, l2 = h2 / 2, d2 = this.getPixelRatio(), c2 = e2.barWidth ? e2.barWidth * d2 : 1, u2 = e2.barGap ? e2.barGap * d2 : e2.barWidth ? c2 / 2 : 0, p = e2.barRadius || 0, m = a2 / (c2 + u2) / o2, g = p && "roundRect" in i2 ? "roundRect" : "rect";
    i2.beginPath();
    let f = 0, v = 0, b = 0;
  ...
  renderLineWaveform(t2, e2, i2, s2) {
    const n2 = (e3) => {
      const n3 = t2[e3] || t2[0], r2 = n3.length, {
        height: o2
      } = i2.canvas, a2 = o2 / 2, h2 = i2.canvas.width / r2;
      i2.moveTo(0, a2);
      let l2 = 0, d2 = 0;
  ...
  renderMultiCanvas(t2, e2, i2, s2, n2, r2) {
    ...
    u2(g - 1), u2(g), u2(g + 1), p > 1 && (this.unsubscribeOnScroll = this.on("scroll", () => {
      const {
        scrollLeft: t3
      } = this.scrollContainer, e3 = Math.floor(t3 / l2 * p);
  ...
  scrollIntoView(t2, e2 = false) {
    const {
      ...
      scrollWidth: s2,
      clientWidth: n2
    } = this.scrollContainer, r2 = t2 * s2, o2 = i2, a2 = i2 + n2, h2 = n2 / 2;
    if (this.isDragging) {
      const t3 = 30;
